...
TASK_PRESETS: dict[str, dict[str, Any]] = {
    "driftmed_eval": {
        "script": "scripts/conflictMedQa.sh",
        "description": "Run ConflictMed / DriftMed evaluation and save raw predictions.",
        "env": {},
    },
    "filter_pairs": {
        "script": "scripts/filter.sh",
        "description": "Filter prediction pairs by margin and pack kept pairs.",
        "env": {},
    },
    "split_pairs": {
        "script": "scripts/split_pairs.sh",
        "description": "Split one kept-pairs jsonl into train/val jsonl files.",
        "env": {},
    },
    "retest": {
        "script": "scripts/retest.sh",
        "description": "Re-run the verifier on kept pairs.",
        "env": {},
    },
    "eval_positions": {
        "script": "scripts/eval.sh",
        "description": "Evaluate support/conflict interventions across positions.",
        "env": {},
    },
    "layer_trace": {
        "script": "scripts/layer_trace.sh",
        "description": "Run layer trace on kept pairs.",
        "env": {},
    },
    "head_scan": {
        "script": "scripts/head_scan.sh",
        "description": "Run attention-head scan from a saved layer-trace plan.",
        "env": {},
    },
    "select_heads": {
        "script": "scripts/select_head.sh",
        "description": "Select conflict-specific heads from the head-scan summary.",
        "env": {},
    },
    "ablate_head": {
        "script": "scripts/ablate.sh",
        "description": "Ablate selected heads on kept pairs.",
        "env": {},
    },
    "ablate_head_random": {
        "script": "scripts/ablate_random.sh",
        "description": "Ablate matched random heads on kept pairs.",
        "env": {},
    },
    "probe_lens": {
    ...
    "standard_metrics": {
        "script": "scripts/compute_standard_metrics.sh",
        "description": "Compute ablation summary metrics for one model output root.",
        "env": {},
    },
}
...
def main() -> int:
    ap = argparse.ArgumentParser(
        description="Launch a Qwen3-4B_exp task by task+model and keep outputs isolated per model slug."
    )
    ap.add_argument("--task", default="", help="Task preset, e.g. layer_trace, head_scan, probe_lens.")
