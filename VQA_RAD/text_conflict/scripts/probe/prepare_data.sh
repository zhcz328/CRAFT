...
TRAIN_CSV="${TRAIN_CSV:-${DATA_ROOT}/vqa_rad_nc_cc_both_correct_train.csv}"
VAL_CSV="${VAL_CSV:-${DATA_ROOT}/vqa_rad_nc_cc_both_correct_val.csv}"
PROBE_ROOT="${PROBE_ROOT:-/root/autodl-tmp/probe_vqa_rad/${MODEL_SLUG}}"
