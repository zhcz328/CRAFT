...
def default_preds_path(project_root, position, model_name="", model="hulumed-4b"):
    results_root = default_eval_results_dir(project_root, model_name=model_name, model=model)
    ...
    new_layout = results_root.parent / f"result_{position}_vqarad" / "eval-results_vqarad_all" / "preds.jsonl"
