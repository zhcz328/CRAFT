...
| Qwen3-4B | After Ablation | 12 | `/root/logit_lens/conflictmedqa/Qwen3-4B_exp/analyze_probe_lens/ablation_flip_before_question_follow/summary.json` |
...
| Hulu-med-4B | After Ablation | 111 | `/root/logit_lens/Slake_vqa/Hulu-med/text_conflict/analyze_probe_lens/ablation_flip_before_question_follow/summary.json` |
| Llama3.2-3B | follow_conflict | 27 | `trajectories.jsonl` |
| Llama3.2-3B | resist | 7 | `trajectories.jsonl` |
| Llama3.2-3B | After Ablation | 22 | `/root/logit_lens/conflictmedqa/Qwen3-4B_exp/llama32_3b/analysis/conflict_retest_ablated_heads_inf_before_question_val/follow_conflict/summary.json` |