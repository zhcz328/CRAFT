...
MODEL_SPECS = [
    {
        ...
        "left_path": DATA_DIR / "hulumed4b_image_selected_heads.json",
        "right_path": DATA_DIR / "hulumed4b_text_selected_heads.json",
    },
    {
        "model": "internvl35_4b",
        "left_label": "Image conflict",
        "right_label": "Text conflict",
        "left_path": DATA_DIR / "internvl35_4b_image_selected_heads.json",
        "right_path": DATA_DIR / "internvl35_4b_text_selected_heads.json",
    },
]
...
def main() -> None:
    ...
    print(f"saved_json={summary_json}")
    print(f"saved_md={summary_md}")
    for result in results:
        print(f"saved_png={result['venn_png']}")
