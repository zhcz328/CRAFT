...
DATA_CSV="${DATA_CSV:-/root/logit_lens/Slake_vqa/image_conflict/data/internvl35_4b/slake_nc_correct_ic_ready.csv}"
IMAGE_ROOT="${IMAGE_ROOT:-/root/logit_lens/Slake_vqa}"
SELECTED_HEADS="${SELECTED_HEADS:-/root/logit_lens/Slake_vqa/image_conflict/internvl35_4b/result_image_conflict_slake/selected_heads_core_layers.json}"
OUT_JSON="${OUT_JSON:-/root/logit_lens/exp/noise/internvl35_4b_noise_ablation_selected_heads_36.json}"
DTYPE="${DTYPE:-bf16}"
DEVICE="${DEVICE:-auto}"
...
NOISE_IMAGE_DIR="${NOISE_IMAGE_DIR:-/root/logit_lens/exp/noise/internvl35_4b_noise_images_36}"
