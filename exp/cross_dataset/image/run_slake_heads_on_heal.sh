...
SELECTED_HEADS="${SELECTED_HEADS:-$ROOT/Slake_vqa/image_conflict/hulumed4b/result_image_conflict_slake/selected_heads_core_layers.json}"
MODEL_PATH="${MODEL_PATH:-/root/autodl-tmp/Hulu-Med-4B}"
MODEL_NAME="${MODEL_NAME:-hulumed-4b}"
DATASET="${DATASET:-heal-medvqa}"
POSITION="${POSITION:-image_conflict}"
MASK_SCOPE="${MASK_SCOPE:-all}"
SPLITS="${SPLITS:-train val}"
OUT_DIR="${OUT_DIR:-$ROOT/exp/cross_dataset/image/results/slake_heads_on_heal}"
