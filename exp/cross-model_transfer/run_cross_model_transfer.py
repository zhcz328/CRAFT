...
OUT_DIR = ROOT / "exp" / "cross-model_transfer"
...
def write_summary(jobs: list[TransferJob]) -> Path:
    ...
    summary = {
        "experiment": "cross_model_transfer_before_question",
...
def main() -> int:
    ...
    jobs = [
        TransferJob(
            ...
            script_path=str(ROOT / "VQA_RAD" / "Hulu-med" / "ablate_head.py"),
            workdir=str(ROOT / "VQA_RAD" / "Hulu-med"),
            data_csv=str(ROOT / "VQA_RAD" / "Hulu-med" / "data" / "nc_cc_both_correct_rerun_tmp_val.csv"),
            image_root=".",
            selected_heads=str(
                ROOT
                / "VQA_RAD"
        ...
        TransferJob(
            ...
            script_path=str(ROOT / "VQA_RAD" / "text_conflict" / "ablate_head.py"),
            workdir=str(ROOT / "VQA_RAD" / "text_conflict"),
            data_csv=str(ROOT / "VQA_RAD" / "text_conflict" / "data" / "internvl35_4b" / "vqa_rad_nc_cc_both_correct_val.csv"),
            image_root=".",
            selected_heads=str(
                ROOT
                / "VQA_RAD"
