...
def default_preds_path(project_root, position):
    results_root = project_root / "eval-results_slake_hulumed4b_all"
    if not results_root.exists():
        return results_root / "__missing__" / position / "preds.jsonl"
    ...
    return results_root / position / "preds.jsonl"
