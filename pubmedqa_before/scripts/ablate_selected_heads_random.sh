...
python ablate_selected_heads.py \
  ...
  --out_summary result_train_prefix/random_ablation_evalstyle_ic_only_summary_prefix_all.json \
  --out_jsonl result_train_prefix/random_ablation_evalstyle_ic_only_preds_prefix_all.jsonl \
  --random_ablate --random_seed 42
