...
IN_CSV="${IN_CSV:-${DATA_ROOT}/${DATASET_NAME}_nc_cc_both_correct.csv}"
VAL_PERCENT="${VAL_PERCENT:-30}"
SEED="${SEED:-42}"
OUT_TRAIN="${OUT_TRAIN:-${DATA_ROOT}/${DATASET_NAME}_nc_cc_both_correct_train.csv}"
OUT_VAL="${OUT_VAL:-${DATA_ROOT}/${DATASET_NAME}_nc_cc_both_correct_val.csv}"
RESUME="${RESUME:-0}"
MODEL_NAME_ARGS=()
